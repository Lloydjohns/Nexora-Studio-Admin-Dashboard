...
export const leads: Lead[] = [
  {
    ...
    message:
      'Looking for someone to manage our Instagram and run monthly campaigns.',
    source: 'Instagram',
    date: '2026-08-06',
    status: 'New',
  },
  {
    ...
    interestedService:
      'Web + Social Pro',
    message:
      'We need a new website and ongoing social media support.',
    source: 'Website',
    date: '2026-08-05',
    status: 'Contacted',
  },
  {
    ...
    message:
      'I want to scale my coaching business online.',
    source: 'Referral',
    date: '2026-08-04',
  ...
  },
  {
    ...
    interestedService:
      'Web & Systems Support',
    message:
      'Need a professional financial services website with client portal.',
    source: 'Facebook',
    date: '2026-08-02',
  ...
  },
  {
    ...
    interestedService:
      'Social Media Management',
    message:
      'We want to attract more patients through social media.',
    source: 'TikTok',
    date: '2026-08-01',
    status: 'Won',
  },
  {
    ...
    interestedService:
      'Social Media Management',
    message:
      'Need help growing our fitness brand online.',
    source: 'Instagram',
    date: '2026-07-28',
    status: 'Lost',
  },
...
export const discoveryCalls: DiscoveryCall[] = [
  {
    ...
    paymentStatus: 'Free',
    notes:
      'Wants to grow IG from 2K to 10K followers in 6 months.',
    outcome: '',
  },
  {
    id: 'DC-202',
    ...
    paymentStatus: 'Paid',
    notes:
      'Needs brand positioning for a coaching pivot.',
    outcome: '',
  },
  {
    id: 'DC-203',
    ...
    paymentStatus: 'Paid',
    notes:
      'Financial services site with client portal requirements.',
    outcome: '',
  },
  {
    id: 'DC-204',
    ...
    paymentStatus: 'Free',
    notes:
      'Local dental clinic, wants appointment bookings via IG.',
    outcome:
      'Converted to client — Social Starter package.',
  },
  {
    id: 'DC-205',
    clientName: 'Eric Tan',
    ...
    paymentStatus: 'Paid',
    notes:
      'Ramen restaurant, needs online menu + reservation system.',
    outcome:
      'Proposal sent — Web + Social Pro.',
  },
];
...
export const contentItems: ContentItem[] = [
  {
    ...
    platform: 'Instagram',
    caption:
      'Glow up your AM routine ✨ New arrivals dropping this week',
    status: 'Approved',
    scheduledDate:
      '2026-08-08T09:00:00',
    designer: 'Kai Santos',
  ...
  },
  {
    ...
    platform: 'TikTok',
    caption:
      'POV: your skincare finally works 🧴',
    status: 'Scheduled',
    scheduledDate:
      '2026-08-09T18:00:00',
    designer: 'Kai Santos',
  ...
  },
  {
    ...
    platform: 'Instagram',
    caption:
      'Monday grind starts here ☕️ #UrbanGrind',
    status: 'Published',
    scheduledDate:
      '2026-08-04T08:00:00',
    designer: 'Kai Santos',
  ...
  },
  {
    ...
    platform: 'Instagram',
    caption:
      'Transform your space with our latest project reveal',
    status: 'In Review',
    scheduledDate:
      '2026-08-10T10:00:00',
    designer: 'Kai Santos',
  ...
  },
  {
    ...
    platform: 'TikTok',
    caption:
      '5 exercises you are doing wrong 🏋️',
    status: 'Draft',
    scheduledDate:
      '2026-08-11T17:00:00',
    designer: 'Kai Santos',
  ...
  },
  {
    ...
    platform: 'Instagram',
    caption:
      'Behind the scenes of our newest design system',
    status: 'Published',
    scheduledDate:
      '2026-08-03T15:00:00',
    designer: 'Kai Santos',
  ...
  },
  {
    ...
    platform: 'Instagram',
    caption:
      'Client spotlight: 6 months of growth 📈',
    status: 'Approved',
    scheduledDate:
      '2026-08-12T10:00:00',
    designer: 'Kai Santos',
  ...
  },
  {
    ...
    platform: 'TikTok',
    caption:
      'Why your aesthetic clinic needs TikTok 🩺',
    status: 'Draft',
    scheduledDate:
      '2026-08-13T19:00:00',
    designer: 'Kai Santos',
  ...
  },
  {
    ...
    platform: 'Instagram',
    caption:
      'New collection preview — coming soon 💌',
    status: 'In Review',
    scheduledDate:
      '2026-08-14T11:00:00',
    designer: 'Kai Santos',
...
export const websiteRequests: WebsiteRequest[] = [
  {
    ...
    goals:
      'Build trust and capture leads online',
    pagesRequested: [
      'Home',
      'Services',
      'About',
  ...
  },
  {
    ...
    goals:
      'Online menu and reservation system',
    pagesRequested: [
      'Home',
      'Menu',
      'About',
  ...
  },
  {
    ...
    goals:
      'Showcase property listings with search',
    pagesRequested: [
      'Home',
      'Listings',
      'Agents',
  ...
  },
  {
    ...
    goals:
      'Online appointment booking and patient education',
    pagesRequested: [
      'Home',
      'Services',
      'Team',
...
export const activities = [
  {
    ...
    type: 'inquiry',
    text:
      'New inquiry from Patricia Lim — Lim Boutique',
    time: '12 minutes ago',
    icon: 'Mail',
  },
  {
    ...
    type: 'call',
    text:
      'Strategy call booked with Michelle Reyes',
    time: '1 hour ago',
    icon: 'Calendar',
  },
  {
    ...
    type: 'payment',
    text:
      'Invoice INV-2026-050 paid by Glow Aesthetics',
    time: '2 hours ago',
    icon: 'CreditCard',
  },
  {
    ...
    type: 'content',
    text:
      'Content piece S-401 approved for Glow Aesthetics',
    time: '3 hours ago',
    icon: 'CheckCircle',
  },
  {
    ...
    type: 'project',
    text:
      'Vellamore Portfolio Website moved to Development',
    time: '5 hours ago',
    icon: 'FolderKanban',
  },
  {
    ...
    type: 'order',
    text:
      'Digital product order O-602 completed — Launch Kit Pro',
    time: '6 hours ago',
    icon: 'ShoppingBag',
  },
  {
    ...
    type: 'client',
    text:
      'Fernandez Real Estate onboarded as new client',
    time: '1 day ago',
    icon: 'UserPlus',
  },
  {
    ...
    type: 'payment',
    text:
      'Invoice INV-2026-046 paid by Urban Grind Coffee',
    time: '1 day ago',
    icon: 'CreditCard',
  },
];
...
export const notifications = [
  {
    ...
    description:
      'INV-2026-049 — Mendoza Law Firm is 13 days overdue',
    time: '1h ago',
    unread: true,
  },
  {
    ...
    title: 'New lead',
    description:
      'Patricia Lim submitted a website inquiry',
    time: '12m ago',
    unread: true,
  },
  {
    ...
    description:
      'S-410 awaiting approval for Paper & Co.',
    time: '3h ago',
    unread: true,
  },
  {
    ...
    description:
      'Vellamore Portfolio Website due in 8 days',
    time: '5h ago',
    unread: false,
  },
];
